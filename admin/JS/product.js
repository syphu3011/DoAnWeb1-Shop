...
$.ajax({
    ...
    success: function(data) {
        ...
        function fillProd(product = obj.product) {
        ...
        //     let qTypeSelect = document.getElementById("select_p")
        //     let pTypeSelect = document.getElementById("select_q")
        //     let strA = ""
        //     let strQ = ""
        //     let strP = ""
        //         //fillA
        ...
        //         //fillQ
        //     obj.largeClassify[2].miniClassify.forEach(element => {
        //         strQ += `<option value="` + element.name + `">` + element.name + `</option>`
        //     })
        //     qTypeSelect.innerHTML = strA
        //         //fillP
