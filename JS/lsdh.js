    ...
    getDataFromServer(
        ...
        function (response) {
            if (response.success) {
                ...
                document.getElementById("maDh").innerHTML =
                    "Số hoá đơn: " + id_hd;
                document.getElementById("ttdh").innerHTML =
                    "Trạng thái: " + status;
                ...
                for (let i = 0; i < sp.length; i++) {
                    ...
                    tien +=
                        `<div>
            ` +
                        calculated(sp[i].price) +
                        ` VND
        </div>`;

                    let sl = "Số lượng: " + sp[i].amount;
                    document.getElementById("ctdh-dssp").innerHTML +=
                        `<div class="ctdh-sp">
                <div>
